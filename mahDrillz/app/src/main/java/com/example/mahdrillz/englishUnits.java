...
public class englishUnits extends Activity{
	 ...
	 public void EnglishFunction() 
	 {
		 final TableLayout tableLayout = (TableLayout) findViewById(R.id.table);
		    ...
		    for (int i = 0; i < (drillSize.length / 3)+1; i++) 
		    {
		        ...
		        switch (drillSize[i + (drillSize.length / 3)+1].length())//Formats
		        {
		        	case 1 : text2.setText("\t" + drillSize[i + (drillSize.length / 3)+1] + "\t\t\t= " + decimalEquiv[i+ (drillSize.length / 3)+1]);
		        	break;
			        case 2 : text2.setText("\t" + drillSize[i + (drillSize.length / 3)+1] + "       = " + decimalEquiv[i+ (drillSize.length / 3)+1]);
			        break;
			        case 3 : text2.setText("\t" + drillSize[i + (drillSize.length / 3)+1] + "     = " + decimalEquiv[i+ (drillSize.length / 3)+1]);
			        break;
			        case 4 : text2.setText("\t" + drillSize[i + (drillSize.length / 3)+1] + "   = " + decimalEquiv[i+ (drillSize.length / 3)+1]);
			        break;
			        case 5 : text2.setText("\t" + drillSize[i + (drillSize.length / 3)+1] + " = " + decimalEquiv[i+ (drillSize.length / 3)+1]);
			        break;
			        default: text2.setText("\t" + drillSize[i + (drillSize.length / 3)+1] + "= " + decimalEquiv[i+ (drillSize.length / 3)+1]);
			        break;
		        }
		        ...
		        if((i + ((drillSize.length / 3)*2)+2) < drillSize.length)
		        {
			        ...
			        switch (drillSize[i + ((drillSize.length / 3)*2)+2].length())
			        {
			        	case 1 : text3.setText("\t" + drillSize[i + ((drillSize.length / 3)*2)+2] + "\t\t\t= " + decimalEquiv[i + ((drillSize.length / 3)*2)+2] + "\t");
			        	break;
				        case 2 : text3.setText("\t" + drillSize[i + ((drillSize.length / 3)*2)+2] + "       = " + decimalEquiv[i + ((drillSize.length / 3)*2)+2] + "\t");
				        break;
				        case 3 : text3.setText("\t" + drillSize[i + ((drillSize.length / 3)*2)+2] + "     = " + decimalEquiv[i + ((drillSize.length / 3)*2)+2] + "\t");
				        break;
				        case 4 : text3.setText("\t" + drillSize[i + ((drillSize.length / 3)*2)+2] + "   = " + decimalEquiv[i + ((drillSize.length / 3)*2)+2] + "\t");
				        break;
				        case 5 : text3.setText("\t" + drillSize[i + ((drillSize.length / 3)*2)+2] + " = " + decimalEquiv[i + ((drillSize.length / 3)*2)+2] + "\t");
				        break;
				        default: text3.setText("\t" + drillSize[i + ((drillSize.length / 3)*2)+2] + "= " + decimalEquiv[i + ((drillSize.length / 3)*2)+2] + "\t");
				        break;
			        }
